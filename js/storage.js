...
// ─── storage.js: LocalStorage CRUD, Backup & Restore ────────────────────────

const STORAGE_KEY = 'vibecoding_appideas_v1';
...
function saveAppState() {
  try {
    ...
    showToast('Storage full! Delete older versions or backup and clear data.', 'error');
